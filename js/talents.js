  ...
  function rendre() {
    ...
    if (sousOnglet === 'catalogue') {
      ...
      const { section: sectionCatalogue, appliquerFiltres } =
        construireBlocCatalogueAbilities(catalogue, save, abilitiesFilters, onSaveChange);
...
function construireBlocCatalogueAbilities(catalogue, save, abilitiesFilters, onSaveChange) {
  const section = document.createElement('section');
  section.className = 'bloc';
